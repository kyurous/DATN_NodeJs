...
const updateBookingStatus = async (req, res) => {
  try {
    ...
    if (!bookingId || !newStatus) {
      return res.status(400).json({ errCode: 1, message: "Missing required params" });
    }
    ...
    if (!booking) {
      return res.status(404).json({ errCode: 2, message: "Booking not found" });
    }
    ...
    return res.status(200).json({ errCode: 0, message: "Update succeed" });
  } catch (e) {
    console.error(e);
